...
spam_keywords = ["money", "win", "discount", "free", "offer", "guaranteed","free","click","website","bank","credit","visa","account","password"]
...
#################################################################
print("You use the KNN algorithm \n")
...
grid_search = GridSearchCV(knn, param_grid, cv=5, scoring=make_scorer(accuracy_score), n_jobs=-1)
